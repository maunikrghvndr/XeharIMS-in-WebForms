...
{
    public partial class BodyMentor : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            {
                using (MySqlCommand cmd = new MySqlCommand("SELECT * FROM saleschannels where status = 'BodyMentor' "))
                {
        ...
        public static string SalesChannels(string date)
        {
            ...
            string query = "TopBodyMentorProfit";
