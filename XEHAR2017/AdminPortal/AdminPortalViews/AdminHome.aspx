<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPortal/adminmaster/AdminPortalMaster.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="XEHAR2017.AdminPortal.AdminPortalViews.AdminHome" %>
...
<div class="content-wrapper">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="../admincomponents/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="../admincomponents/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="../admincomponents/dist/img/user2-160x160.jpg" alt="user image" class="offline">
  ...
  <%--  <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                type: "POST",
                url: "../../VendorPortal/vendorviews/home.aspx/MyMethod",
                data: "{Param1: '10'}",
