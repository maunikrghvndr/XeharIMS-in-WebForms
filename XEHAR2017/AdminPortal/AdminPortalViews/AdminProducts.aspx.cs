...
namespace XEHAR2017.AdminPortal.AdminPortalViews
{
    public partial class AdminProducts : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string Customers(string date)
        {
        ...
        [WebMethod]
        public static List<string> TopSalesChannels(string date, string[] pid)
        {
