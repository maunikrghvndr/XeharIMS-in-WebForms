<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPortal/adminmaster/AdminPortalMaster.Master" AutoEventWireup="true" CodeBehind="BodyMentorView.aspx.cs" Inherits="XEHAR2017.AdminPortal.AdminPortalViews.BodyMentorView" %>
          ...
          var scid = '<%=GetSCID()%>'
            ...
            function onSucess(result) {
                ...
                //---------------------------------------------------
                    ...
                    var chart = new google.visualization.ColumnChart(document.getElementById('piechar'));
