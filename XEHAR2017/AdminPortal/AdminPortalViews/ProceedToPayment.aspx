<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProceedToPayment.aspx.cs" Inherits="XEHAR2017.AdminPortal.AdminPortalViews.ProceedToPayment" %>
...
<body>
    ...
    <br />
    <asp:Button ID="btnPay" runat="server" Text="Pay Now" CssClass="button" Style="font-size: 12px; cursor: pointer; height: 27px; margin-left: 207px; margin-top: 10px; width: 93px;" OnClick="pay" ValidationGroup="save"></asp:Button>
</div>
    </div>
    </form>
</body>
