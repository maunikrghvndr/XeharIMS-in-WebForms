...
{
    public partial class Ambassadors : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            {
                using (MySqlCommand cmd = new MySqlCommand("SELECT * FROM ambassadors "))
                {
        ...
        [WebMethod]
        public static string TopAmbassadors(string date)
        {
        ...
        [WebMethod]
        public static List<string> TopAmbassadorsProduct(string date, string[] scid)
        {
