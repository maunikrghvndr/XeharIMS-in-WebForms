...
namespace XEHAR2017.AdminPortal.AdminPortalViews
{
    public partial class ProceedToPayment : System.Web.UI.Page
    {
          ...
          string phone, string email, string currency)
        {
            ...
            redirecturl += "&city=los angeles";

            //State i assign static based on login user detail you change this value
            redirecturl += "&state=California";
        ...
        protected void pay(object sender, EventArgs e)
        {
            ...
            string currency = ddlCurrency.Text.ToString();
            string info = txtPurpose.Text.ToString();


            PayWithPayPal(amount, info, name,
