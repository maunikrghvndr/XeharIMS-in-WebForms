...
namespace XEHAR2017
{
    public partial class VendorsWithProfit : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string TopVendors(string date)
        {
        ...
        [WebMethod]
        public static List<string> TopVendorsProduct(string date, string[] vid)
        {
            ...
            foreach (string s in vid)
            {
                ...
                string query = "TopVendorsProductProfit";
